 ...
 */
import { HomeSection, SearchRequest, Manga, Request, Chapter, ChapterDetails, TagSection, MangaUpdates, RequestManager, PagedResults, Cookie, RequestHeaders, Section, SearchField } from "..";
import { Requestable } from "./Requestable";
import { Searchable } from "./Searchable";
export declare abstract class Source implements Requestable, Searchable {
    cheerio: CheerioAPI;
